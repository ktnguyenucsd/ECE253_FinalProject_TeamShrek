...
group_device.add_argument('--device_type', type=str, choices=('cpu', 'cuda', 'xla'), default='cuda', help='device to run models')
...
group_data.add_argument('--data_root', type=str, default='/content/drive/MyDrive/Video_parsing', help='dataset root location')
